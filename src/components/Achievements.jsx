import  Img from "../images/property21.png"
      ...
      <div className="w-[90%] mx-auto mt-[3rem]">
        ...
        <div className="flex flex-wrap gap-24 mt-8">
          <div className="relative flex-1 basis-[18rem]">
            ...
            />
            <div className="absolute w-4/5 p-3 -translate-x-1/2 border-4 border-[#fff] rounded-lg -bottom-10 left-1/2 dark:border-main-dark bg-secondary text-[#fff]">
              <div className="gap-5 flex items-center justify-between">
                ...
                <div>
                  <h1 className="text-2xl font-bold text-primary">32550+</h1>
                  <p>People Joined</p>
                </div>
              </div>
            </div>
