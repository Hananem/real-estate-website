...
<div    className={`flex-1 ${
 ...
 <div className="group !opacity-100 overflow-hidden relative">
        ...
        <div className="absolute bottom-0 left-0 w-full px-2 py-2 transition-transform bg-gradient-to-t from-[#000]/80 sm:translate-y-10 group-hover:translate-y-0 to-transparent">
