...
const FiltersSection = () => {
  return (
    <div className="md:max-w-[80%] w-full mx-auto relative -mt-16 sm:-mt-28">
      <div className="bg-[#fff] p-4  border-[#cbd5e1] rounded-lg dark:bg-card-dark dark:border-dark shadow dark:shadow-none">
        ...
        <div className="z-40 flex-col mt-4 gap-x-4 flex justify-between gap-y-4 md:gap-y-0 md:flex-row ">
          <div className="flex-col flex-1 w-full flex items-center gap-x-4 md:w-fit sm:flex-row gap-y-4 sm:gap-y-0">
            <div className="flex-1 w-full p-2 rounded-lg md:w-fit bg-[#fff] dark:bg-hover-color-dark md:!transparent">
