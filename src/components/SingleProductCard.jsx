...
const SingleProductCard = ({
  ...
  return (
    <div
      ...
      } shadow-light dark:border-card-dark border-[#cbd5e1] rounded-lg overflow-hidden relative group`}
    >
      <div className="group !opacity-100 overflow-hidden relative">
        ...
        <div className="absolute bottom-0 left-0  px-2 py-2 transition-transform bg-[#fff] backdrop-blur-sm text-secondary rounded-lg">
          <div className="text-[fff] flex items-center gap-x-2">
            <BiMap />
            <p>{location}</p>
          </div>
        </div>
      ...
      <div className="p-3">
        ...
        <div className="flex justify-between mt-3">
          <div className="flex items-center gap-x-2">
            <div className="icon-box !w-4 !h-4 bg-primary/20 hover:!bg-primary/40 text-primary">
              <BiBed />
            </div>
